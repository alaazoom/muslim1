...
//   @override
//   State<MorningAzkarPage> createState() => _AzkarPageState();
// }

// class _AzkarPageState extends State<MorningAzkarPage> {
...
//  List<int>counter = [
//   1,3,3,3,1,1,3,4,1,7,3,1,1,3,3,3,1,3,1,1,3,10,3,3,3,3,10,10,100,100,100

//  ];

//   late List<int> savedCounter;
...
//       savedCounter = List.from(counter);

//       box.put("counters", savedCounter);
//       box.put("day", today);

//     } else {

//       savedCounter = box.get("counters", defaultValue: counter).cast<int>();
//     }
//   }

//   void decrease(int index) {

//     if (savedCounter[index] > 0) {
//       setState(() {
//         savedCounter[index]--;
//       });
...
//         centerTitle: true,
//         title: Text("أذكار الصباح",style: TextStyle
